      ...
      <div className="flex w-full">
        ...
        <div className="w-full">
          ...
          >
            <SwiperSlide>
              <div className="bg-gray-100 rounded-md overflow-hidden shadow-none hover:shadow-none transition duration-300 relative group cursor-pointer">
                ...
                <div className="relative w-full h-65 z-0">
                  ...
                  <img
                    src="/popular-images/girl1.jpg" // Change the image path accordingly
                    alt="Image 1"
            ...
            <SwiperSlide>
              <div className="bg-gray-100 rounded-md overflow-hidden shadow-none hover:shadow-none transition duration-300 relative group cursor-pointer">
                ...
                <div className="relative w-full h-65 z-0">
                  ...
                  <img
                    src="/popular-images/girl2.jpg" // Change the image path accordingly
                    alt="Image 2"
                    className="w-full h-full object-cover group-hover:brightness-90 transition duration-300"
                  />
            ...
            <SwiperSlide>
              <div className="bg-gray-100rounded-md overflow-hidden shadow-none hover:shadow-none transition duration-300 relative group cursor-pointer">
                {/* Image container with the hover effect */}
                <div className="relative w-full h-65 z-0">
                  {/* Full card hover overlay (covers image only) */}
                  <div className="absolute inset-0 bg-blue-900 opacity-0 group-hover:opacity-20 transition-opacity duration-300 z-10"></div>
                  ...
                  <img
                    src="/popular-images/emilia.jpg" // Change the image path accordingly
                    alt="Image 3"
                    className="w-full h-full object-cover group-hover:brightness-90 transition duration-300"
                  />
            ...
            <SwiperSlide>
              <div className="bg-gray-100 rounded-md overflow-hidden shadow-none hover:shadow-none transition duration-300 relative group cursor-pointer">
                ...
                <div className="relative w-full h-65 z-0">
                  ...
                  <img
                    src="/popular-images/image2.jpeg" // Change the image path accordingly
                    alt="Image 4"
                    className="w-full h-full object-cover group-hover:brightness-90 transition duration-300"
                  />
            ...
            <SwiperSlide>
              <div className="bg-gray-100 rounded-md overflow-hidden shadow-none hover:shadow-none transition duration-300 relative group cursor-pointer">
                ...
                <div className="relative w-full h-65 z-0">
                  ...
                  <img
                    src="/popular-images/image1.jpg" // Change the image path accordingly
                    alt="Image 5"
                    className="w-full h-full object-cover group-hover:brightness-90 transition duration-300"
                  />
