            ...
            <SwiperSlide>
              <div className="bg-gray-100 rounded-md overflow-hidden shadow-none hover:shadow-none transition duration-300 relative group cursor-pointer">
                ...
                <div className="relative w-full h-65 z-0">
                  ...
                  <img
                    src="/popular-images/7.jpeg" // Change the image path accordingly
                    alt="Image 1"
            ...
            <SwiperSlide>
              <div className=" rounded-md overflow-hidden shadow-none hover:shadow-none transition duration-300 relative group cursor-pointer">
                ...
                <div className="relative w-full h-65 z-0">
                  ...
                  <img
                    src="/popular-images/8.jpeg" // Change the image path accordingly
                    alt="Image 2"
                    className="w-full h-full object-cover group-hover:brightness-90 transition duration-300"
                  />
            ...
            <SwiperSlide>
              <div className=" rounded-md overflow-hidden shadow-none hover:shadow-none transition duration-300 relative group cursor-pointer">
                ...
                <div className="relative w-full h-65 z-0">
                  ...
                  <img
                    src="/popular-images/9.jpeg" // Change the image path accordingly
                    alt="Image 3"
                    className="w-full h-full object-cover group-hover:brightness-90 transition duration-300"
                  />
